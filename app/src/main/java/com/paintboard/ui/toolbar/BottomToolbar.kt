...
import com.paintboard.domain.model.EraserSize
import com.paintboard.domain.model.StrokeWidth
import com.paintboard.ui.canvas.CanvasViewModel
    ...
    Row(
        ...
        Box(
            ...
            androidx.compose.material3.Icon(
                ...
                tint = if (collabState.role != com.paintboard.ui.canvas.CanvasViewModel.CollabRole.NONE)
            ...
            if (showCollabPanel) {
                com.paintboard.ui.collab.CollabPopup(
        ...
        Box(
            ...
            if (showSharePanel) {
                com.paintboard.ui.share.SharePopup(
        ...
        Box(
            ...
            if (showPageManager) {
                com.paintboard.ui.pages.PageManagerPopup(
                    pages = pages,
