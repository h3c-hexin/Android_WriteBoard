package com.h3c.writeboard.ui.pages
...
import com.h3c.writeboard.ui.theme.ErrorRed
import com.h3c.writeboard.ui.theme.IconDefault
import com.h3c.writeboard.ui.theme.IconDisabled
import com.h3c.writeboard.ui.theme.PrimaryBlueDark
    ...
    ToolbarPopup(onDismiss = onDismiss, shadowElevation = 16.dp) {
        Column(
                ...
                LazyRow(
                    ...
                    item { AddPageCard(enabled = pages.size < CanvasViewModel.MAX_PAGES, onClick = onAddPage) }
                }
            }
        }
    }
